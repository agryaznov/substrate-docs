...
Let's now deploy it and register a domain name. You could do this alongside all previously deployed contracts. Or, to make things more clear, let's restart our dev node (which clears storage) and remove all old contract instances from the *UI*. 
