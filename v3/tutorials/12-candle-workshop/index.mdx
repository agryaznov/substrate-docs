...
In case shown on the screenshots, Bob became the winner with his bid of *110 Units*. Note that while Eve bidded a larger amount, her bid happened to occur in some round after "candle went out", hence she lost. That's a vivid example of a candle auction result! 
